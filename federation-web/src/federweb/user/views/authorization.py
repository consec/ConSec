...
#     success_url = reverse_lazy('user_authorization_organizations')
#
...
#     url = reverse_lazy('user_authorization_organizations')
...
#         return reverse_lazy('user_authorization_organizations_clients', self.organization_id)
#
#     def form_valid(self, form):
...
#         self.organization_id = self.kwargs['organization_id']
#         self.model = oauth.authorization_organizations_clients(self.organization_id)
#         self.url = reverse_lazy('user_authorization_organizations_clients', self.organization_id)
