package org.consec.auditing.client.amqp.utils;
...
public class Conf {
    ...
    public static String getAmqpServerHost() {
        return props.getProperty("audit-client-amqp.server.host");
    }

    public static int getAmqpServerPort() {
        return Integer.parseInt(props.getProperty("audit-client-amqp.server.port"));
    }

    public static String getExchangeName() {
        return props.getProperty("audit-client-amqp.exchange.name");
    }

    public static int getConnRetryTime() {
        return Integer.parseInt(props.getProperty("audit-client-amqp.connection.retryTime"));
    }
}
