...
//      }
            ...
            */
            ...
            customAttrs.put(SecurityCommons.CONTRAIL_ATTRIBUTE_ASSERTION, xml);
            String accessToken = (String) request.getAttribute("access_token");
            if (accessToken == null) {
                throw new Exception("Failed to create certificate: access token is null.");
            }
            customAttrs.put(SecurityCommons.CONTRAIL_ACCESS_TOKEN_OID, accessToken);
            X509Certificate cert = sc.createUserCertificateWithCustomAttrs(
