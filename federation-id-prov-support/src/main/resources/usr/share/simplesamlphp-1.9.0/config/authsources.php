...
'contrail-multi' => array(
    ...
    'sources' => array(
        'contrailauth' => array(
            'text' => array(
                'en' => 'Log in using a Contrail DB',
            ),
        ),
        'google-contrail' => array(
            'text' => array(
                'en' => 'Log in using the Google IdP',
            ),
        ),
	'testshibb-two'=> array(
            'text' => array(
                'en' => 'Log in using the testshibb-two portal',
            ),
        ),
    ),
        ),
	...
	'contrailauth' => array(
		'contrailmodule:CAuth',
		'dsn' => 'http://localhost:8080/federation-api',
		'idp_name' => 'contrail-idp-xlab',
        ),
