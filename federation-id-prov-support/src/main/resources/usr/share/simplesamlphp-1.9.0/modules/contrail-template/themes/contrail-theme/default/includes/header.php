...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="/<?php echo $this->data['baseurlpath']; ?>resources/contrail-theme/style/style.css" />
	<link rel="icon" type="image/icon" href="/<?php echo $this->data['baseurlpath']; ?>resources/contrail-theme/img/favicon.ico" />
<?php
...
-->
	...
	?>
	<div id="content">
<center><a style="text-decoration: none; color: black" href="/<?php echo $this->data['baseurlpath']; ?>"><img src="/<?php echo $this->data['baseurlpath']; ?>resources/contrail-theme/img/logo.png" alt="Contrail logo"  /></a></center>
